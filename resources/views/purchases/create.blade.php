...
@section('navbar-title', 'إضافة أمر شراء')
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody id="purchaseItems" class="bg-white divide-y divide-gray-200">
                                <tr class="purchase-row">
                                    ...
                                    <td class="px-4 py-3">
                                        <input type="number" name="items[0][cost_price]" value="0" min="0" step="0.01"
                ...
                <div class="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg p-6 mb-6 border border-purple-200">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center pb-2">
                            ...
                            <span id="subtotalDisplay" class="font-bold text-lg text-gray-900">0.00 ج.م</span>
                        </div>
                        <div class="flex justify-between items-center pb-2 border-b border-purple-300">
                            ...
                            <span id="taxDisplay" class="font-bold text-lg text-gray-900">0.00 ج.م</span>
                        </div>
                        <div class="flex justify-between items-center pt-2">
                            <span class="text-gray-900 font-bold text-xl">إجمالي التكلفة:</span>
                            <span id="totalDisplay" class="font-bold text-2xl text-purple-600">0.00 ج.م</span>
                        </div>
                    </div>
                </div>
